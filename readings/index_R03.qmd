...
## The principles of `tidydata` are:
...
For example, don't have a column called group with values "Con_male", "CON_female", "Exp_M", Exp F". Why might this be a problem? First, it is combining 2 observations into one field (group and sex). Second, it is changing the notation styles making the entries inconsistent.
...
-   Pipe commands together to perform multiple commands in sequence
:::
