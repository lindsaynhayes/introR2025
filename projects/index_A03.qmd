...
3. Navigate to this [link](https://github.com/lindsaynhayes/introR2025/tree/main/swirl) to download the Swirl lesson file 3_Exploratory_Data_Analysis.swc

4. Once you have downloaded the file, in the console of RStudio run the following command and interactively choose the 3_Exploratory_Data_Analysis.swc file you just downloaded
