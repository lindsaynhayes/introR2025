...
3)  Copy and paste the content into your new Quarto Document. Make sure the code chunks copied too.
...
# import data frame. What do you need to know? 
...
taylor <- read_csv(file = "taylorswift.csv")
...
taylor$album_name <- factor(taylor$album_name)
...
mat <- taylor[,c(5,6,8,10,11,12,13,14,15)]
